...
htmlhelp_basename = 'EasyDiscorddoc'
...
latex_documents = [
    (master_doc, 'EasyDiscord.tex', 'EasyDiscord Documentation',
     'Taku', 'manual'),
]
...
man_pages = [
    (master_doc, 'easydiscord', 'EasyDiscord Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EasyDiscord', 'EasyDiscord Documentation',
     author, 'EasyDiscord', 'One line description of project.',
     'Miscellaneous'),
]
